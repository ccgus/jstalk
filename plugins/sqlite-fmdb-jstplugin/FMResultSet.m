...
+ (id)resultSetWithStatement:(JSTStatement *)statement usingParentDatabase:(JSTDatabase*)aDB {
...
- (JSTStatement *)statement {
    return statement;
}

- (void)setStatement:(JSTStatement *)value {
    if (statement != value) {
        [statement release];
